    ...
    def forward(self, x_dict, edge_index_dict):
        ...
        for edge_type, edge_index in edge_index_dict.items():
            ...
            if edge_index.shape[1] > 0:  # 如果有边
                ...
                # 根据方向性过滤边
                direction = self.edge_directions.get(edge_type, 'forward')
                if direction == 'forward':
                    directed_edge_index_dict[edge_type] = valid_edge_index
        ...
        for edge_type, edge_index in directed_edge_index_dict.items():
