...
class MultimodalDataset(Dataset):
    def __init__(self, vine_labeled_path, text_features_path, frame_features_dir, comment_ids_path, graph_path='knowledge_graph/knowledge_graph.pkl'):
        # 加载videolink到postid的映射
        self.url_to_postid = {}
        with open('data/urls_to_postids.txt', 'r') as f:
            for line in f:
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = create_data_loaders(
        vine_labeled_path="data/label_data/vine_labeled_cyberbullying_data.csv",
        text_features_path="data/processed/vine_features.npy",
