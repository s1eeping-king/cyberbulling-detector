...
class DataLoader:
    ...
    def load_data(self):
        ...
        try:
            ...
            # 加载视频数据
            with open('data/SampledASONAMPosts.json', 'r', encoding='utf-8') as f:
                for line in f:
                    try:
            ...
            # 加载评论数据
            with open('data/sampled_post-comments_vine.json', 'r', encoding='utf-8') as f:
                for line in f:
                    try:
            ...
            # 加载用户数据
            with open('data/vine_users_data.json', 'r', encoding='utf-8') as f:
                for line in f:
                    try:
            ...
            # 加载标签数据
            self.cyberbullying_data = pd.read_csv('data/label_data/vine_labeled_cyberbullying_data.csv')
            self.emotion_data = pd.read_csv('data/label_data/aggregate video emotion survey.csv')
            self.individual_emotion_data = pd.read_csv('data/label_data/individual video emotion survey.csv')
            
            # 加载postId和videolink的映射关系
            # 尝试多个可能的路径
            possible_paths = [
                'data/urls_to_postids.txt',
                'data/label_data/urls_to_postids.txt',
                'data/processed/urls_to_postids.txt'
            ]
            ...
            # 加载视频帧特征
            frame_features_dir = 'data/processed/frame_features'
            ...
            # 加载评论特征
            try:
                comment_features_path = 'data/processed/vine_features.npy'
                ...
                # 加载评论ID映射
                comment_ids_path = 'data/processed/comment_ids.txt'
