...
def load_knowledge_graph(path: str = 'knowledge_graph/knowledge_graph.pkl') -> Tuple[torch.Tensor, torch.Tensor]:
    """加载知识图谱数据"""
    try:
...
if __name__ == "__main__":
    ...
    try:
        ...
        node_features, edge_index = load_knowledge_graph('knowledge_graph/knowledge_graph.pkl')
